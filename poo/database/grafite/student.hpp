...
public:
  ...
  - Crie a classe `Lapiseira` com o atributo `tip` inicializado como `null`.*/
    ...
    // Verifique se o grafite tem tamanho suficiente para escrever a folha inteira
    ...
    // Calcule o tamanho final após a escrita da folha completa
    int finalSize = currentSize - usage;

    // Se o tamanho final for menor que 10mm, escreva apenas o que for possível
    if (finalSize < 10) {
